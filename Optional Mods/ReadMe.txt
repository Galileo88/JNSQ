...
RationalResources (Individual extras)
= = = =
Drop any one or more of the RR_xyz config files into the GameData folder of your preferred KSP install. These are found in RationalResources_Extras/GameData/
